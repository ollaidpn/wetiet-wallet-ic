                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @endcan
                            @can('view-any', App\Models\Transfert::class)
                            <a class="dropdown-item" href="{{ route('transferts.index') }}">Transferts</a>
                            @endcan
                            @can('view-any', App\Models\Tokenizer::class)
                            <a class="dropdown-item" href="{{ route('tokenizers.index') }}">Tokenizers</a>
                            @endcan
                            ...
                            <a class="dropdown-item" href="{{ route('shops.index') }}">Shops</a>
                            @endcan
                            @can('view-any', App\Models\Refueling::class)
                            <a class="dropdown-item" href="{{ route('refuelings.index') }}">Refuelings</a>
                            @endcan
